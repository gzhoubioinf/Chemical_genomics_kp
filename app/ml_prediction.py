...
def app_fasta_prediction(config):
    ...
    with st.spinner("Loading XGBoost models..."):
        model_opacity, model_circ, model_size = load_xgb_models_for_condition(condition, MODEL_PATHS)
    ...
    if uploaded_file is not None and model_opacity and model_circ and model_size:
        ...
        # 1) Check against known resistance/virulence genes
        ...
        # 2) Convert to unitig vector, predict
